...
def friendly_index(G_0, G_1, u, v, hist=None):
    ...
    :param G_1: network graph at time t=-1 (yesterday)
    :param u: a node
...
def prob_p_forall_index(p):
    """
    very naive probability index that assignes for every (u,v) edge probability p to form
...
if __name__ == '__main__':
    ...
    new_edges_method = prob_p_forall_index(0.001)
    ...
    if finish_without_simulation:
        exit("Finished without simulating")
